...
const SeriesList = () => {
  ...
  return (
    <div className="container-fluid container-charcaters-list container-series-list">
      <motion.div
                    ...
                    <div className="comics-character-list">
                      ...
                      {characters.length > 9 && (
                        <button
                          ...
                          onClick={() =>
                            navigate(
                              `/characters/${selectedSerie.id.toString()}-series-All/`
                            )
                          }
                        >
                          See all characters...
                    ...
                    <div className="comics-character-list">
                      ...
                      {comics.length > 9 && (
                        <button
                          ...
                          onClick={() =>
                            navigate(
                              `/comics/${selectedSerie.id.toString()}-series-All/`
                            )
                          }
                        >
                          See all comics...
                    ...
                    <div className="comics-character-list">
                      ...
                      {events.length > 9 && (
                        <button
                          ...
                          onClick={() =>
                            navigate(
                              `/events/${selectedSerie.id.toString()}-series-All/`
                            )
                          }
                        >
                          See all events...
