...
export const loadCharacters = createAsyncThunk(
  ...
  async (letter = 'a') => {
    const response = await fetch(`https://gateway.marvel.com:443/v1/public/characters?nameStartsWith=${letter}&orderBy=name&limit=100&ts=1000&apikey=ed2af8fad6429d8d927d100991c84a26&hash=be93f5fa58ad58c9ef658f7e99e84904`);
