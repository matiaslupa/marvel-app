...
export const loadEvents = createAsyncThunk(
  ...
  async (event = 'a') => {
    ...
    if (regex.test(event) && event.length <= 5) {
      url = `https://gateway.marvel.com:443/v1/public/events?comics=${event}&orderBy=name&limit=25&ts=1000&apikey=ed2af8fad6429d8d927d100991c84a26&hash=be93f5fa58ad58c9ef658f7e99e84904`;
      ...
      url = `https://gateway.marvel.com:443/v1/public/events?limit=100&ts=1000&apikey=ed2af8fad6429d8d927d100991c84a26&hash=be93f5fa58ad58c9ef658f7e99e84904`;
    }
